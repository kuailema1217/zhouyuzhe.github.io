;( function() {
  var data = {
    ...
    pieChart  : [
      {
        color       : 'red',
        description : 'This 10 percent probability is not caught.',
        title       : 'flowers',
        value       : 0.1
      },
      {
        color       : 'blue',
        description : 'We are 90 percent sure about the demand of energy would not go beyound the estimated value.',
        title       : 'trains',
        value       : 0.9
      }
    ]
 ...
 var mydata;
 d3.csv("data/South_Australia.csv", function(d) {      //careful about the relative path
  mydata=d; 
  doit()
  });
...
/*    var parse = d3.time.format( '%Y-%m-%d' ).parse;
    ...
    */
    ...
    var containerEl = document.getElementById( elementId ),
        ...
        x          = d3.scale.linear().range( [ 0, width - detailWidth ] ),
    ...
    //can set the y scale here
    y.domain( [ 0, d3.max( data, function( d ) { return d.value; } ) +800 ] );
  ...
  function doit() {
    ...
    drawLineChart(    'lineChart',    mydata );
  }
